      ...
      <Router>
        <nav>
          <ul>
            ...
            <li>
              <NavLink exact to="/test/ucenter/1005/lee">
                URL 传参
              </NavLink>
            </li>
            <li>
              <NavLink exact to="/querystringdemo?id=1001&name=lee">
                QueryStringDemo
              </NavLink>
            </li>
            <li>
        ...
        <Switch>
          ...
          <Route
            ...
            exact
            path="/test"
            render={(props) => <Test {...props} name="lee" />}
          ></Route>
          <Route
            strict
            exact
            path="/test/ucenter/:id?/:name?"
            render={(props) => <Test {...props} name="lee" />}
          ></Route>
          <Route
            strict
